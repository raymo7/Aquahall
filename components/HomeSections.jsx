        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 py-16 md:grid-cols-[1.05fr_.95fr] md:py-24">
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3 text-sm text-[var(--teal-100)]">
              <span className="hero-pill"><Clock3 size={15} /> 8 AM–9 PM</span>
              <span className="hero-pill"><MapPin size={15} /> Around 20 km</span>
              <span className="hero-pill"><MessageCircle size={15} /> WhatsApp confirmation</span>
            </div>
          </div>
