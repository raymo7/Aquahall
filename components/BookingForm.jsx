  ...
  return (
    <section id="booking" className="relative overflow-hidden bg-[var(--cream-100)] px-4 py-16 sm:px-6 md:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        {!booking ? (
          <div className="mx-auto overflow-hidden rounded-[28px] border border-[var(--teal-100)] bg-white shadow-[0_24px_70px_rgba(18,49,48,0.12)]">
                ...
                {step === 2 && (
                  <div>
                    ...
                    <div className="mt-6 grid gap-5 sm:grid-cols-2">
                      ...
                      <Field label="Phone *">
                        <input className="field" type="tel" inputMode="tel" value={form.phone} onChange={(event) => update('phone', event.target.value)} placeholder="10-digit mobile number" />
                      </Field>
