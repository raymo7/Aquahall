  ...
  const rows = await db`
    insert into bookings
      (id, name, phone, email, vehicle_type, vehicle_model, vehicle_category, package_id,
       alacarte, services, vehicle_count, vehicles, service_type, group_offer, group_location_mode, care_details, address, map_address, landmark, place_id, latitude, longitude, booking_date, booking_time,
    ...
    values
      (${id}, ${booking.name}, ${booking.phone}, ${booking.email || null}, ${booking.vehicleType},
       ...
       ${booking.services}, ${booking.vehicleCount || 1}, ${JSON.stringify(booking.vehicles || [])}, ${booking.serviceType || 'complete'}, ${Boolean(booking.groupOffer)}, ${booking.groupLocationMode || null}, ${booking.careDetails ? JSON.stringify(booking.careDetails) : null}, ${booking.address}, ${booking.mapAddress}, ${booking.landmark || null}, ${booking.placeId || null}, ${booking.latitude},
