  ...
  const rows = await db`
    insert into bookings
      (id, name, phone, email, vehicle_type, vehicle_model, vehicle_category, package_id,
       alacarte, services, address, map_address, landmark, place_id, latitude, longitude, booking_date, booking_time,
    ...
    values
      (${id}, ${booking.name}, ${booking.phone}, ${booking.email || null}, ${booking.vehicleType},
       ...
       ${booking.services}, ${booking.address}, ${booking.mapAddress}, ${booking.landmark || null}, ${booking.placeId || null}, ${booking.latitude},
